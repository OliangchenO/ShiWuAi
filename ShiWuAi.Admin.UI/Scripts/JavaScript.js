...
function(a) {
    ...
    var b = function(c, d) {
        ...
        b.DEFAULTS, a(c).data(), "object" == typeof d && d),
        ...
        this.$original_element = a(c),
        this.init(c),
        a(c).on("editable.focus", a.proxy(function() {
    ...
    b.initializers = [],
    b.count = 0,
    b.VALID_NODES = ["P", "PRE", "BLOCKQUOTE", "H1", "H2", "H3", "H4", "H5", "H6", "DIV", "LI", "TD", "TH"],
    b.LANGS = [],
    b.DEFAULTS = {
    ...
    b.prototype.destroy = function() {
        ...
        this.addFrTag(),
        this.hide(),
        this.isHTML && this.html(),
        this.focus(),
        this.clearSelection(),
        this.$element.blur(),
        this.$bttn_wrapper && this.$bttn_wrapper.html("").removeData().remove(),
        this.$editor && this.$editor.html("").removeData().remove(),
        this.raiseEvent("destroy"),
        this.$popup_editor && this.$popup_editor.html("").removeData().remove(),
        clearTimeout(this.ajaxInterval),
        clearTimeout(this.typingTimer),
        this.$element.off("mousedown mouseup click keydown keyup cut focus keypress touchstart touchend touch drop"),
        this.$element.off("mousedown mouseup click keydown keyup cut focus keypress touchstart touchend touch drop", "**"),
        a(window).off("mouseup." + this._id),
        a(window).off("keydown." + this._id),
        a(window).off("keyup." + this._id),
        a(window).off("blur." + this._id),
        a(window).off("hide." + this._id),
        a(window).off("scroll." + this._id),
        a(window).off("orientationchange." + this._id),
        a(document).off("selectionchange." + this._id),
        void 0 !== this.$upload_frame && this.$upload_frame.remove(),
        this.$textarea && (this.$box.remove(), this.$textarea.removeData("fa.editable"), this.$textarea.show());
    ...
    b.prototype.triggerEvent = function(b, c, d, e) {
        ...
        var f = !0,
        g = b + "Callback";
        return this.options[g] && a.isFunction(this.options[g]) && (f = c ? this.options[g].apply(this, c) : this.options[g].call(this)),
        c || (c = []),
        f = this.$original_element.triggerHandler("editable." + b, a.merge([this], c)),
        d === !0 && (this.sync(), this.isResizing() || this.editableDisabled || this.imageMode || !e || this.cleanify()),
        void 0 === f ? !0 : f
    },
    b.prototype.syncCleanHTML = function(a, b) {
        var c;
        if (b) for (c = a.replace(/<span((?!class\s*=\s*["']?f-marker["']?)[^>])*?><\/span>/gi, ""); a != c;) a = c,
        c = a.replace(/<span((?!class\s*=\s*["']?f-marker["']?)[^>])*?><\/span>/gi, "");
        else for (c = a.replace(/<span[^>]*?><\/span>/g, ""); a != c;) a = c,
        c = a.replace(/<span[^>]*?><\/span>/g, "");
        return a
    },
    ...
    b.prototype.sync = function() {
        if (!this.isHTML) {
            ...
            this.isLink || this.isImage || this.$element.trigger("placeholderCheck");
            var a = this.getHTML();
            this.isHTML || (this.trackHTML !== a && null != this.trackHTML ? (this.triggerEvent("contentChanged", [], !1, !1), this.refreshImageList(), this.refreshButtons(), this.trackHTML = a) : null == this.trackHTML && (this.trackHTML = a)),
            this.$textarea && this.$textarea.val(a)
        }
    },
    ...
    b.prototype.continueInit = function() {
        this.browserFixes(),
        this.editableDisabled || (this.initUndoRedo(), this.enableTyping(), this.initShortcuts()),
        this.initTabs(),
        this.initEditor(),
        this.isLink || this.initDrag();
        for (var b = 0; b < a.Editable.initializers.length; b++) a.Editable.initializers[b].call(this);
        this.initOptions(),
        this.initEditorSelection(),
        this.editableDisabled || (this.setPlaceholder(), this.setPlaceholderEvents()),
        this.initAjaxSaver(),
        this.setLanguage(),
        this.setCustomText(),
        this.editableDisabled || this.registerPaste(),
        this.initialized = !0,
        this.triggerEvent("initialized", [], !1, !1)
    },
    b.prototype.init = function(b) {
        this.initElement(b),
        this.initElementStyle(),
        this.options.initOnClick ? (this.editableDisabled || this.$element.attr("contenteditable", !0), this.$element.bind("mousedown", a.proxy(function(a) {
            a.stopPropagation(),
    ...
    b.prototype.initOnTextarea = function(b) {
        this.$textarea = a(b),
        void 0 !== this.$textarea.attr("placeholder") && "Type something" == this.options.placeholder && (this.options.placeholder = this.$textarea.attr("placeholder")),
        this.$element = a("<div>").html(this.$textarea.val()),
    ...
    b.prototype.initOnLink = function(b) {
        this.isLink = !0,
        this.selectionDisabled = !0,
        this.editableDisabled = !0,
        this.options.buttons = [],
        this.$element = a(b),
        this.options.paragraphy = !1,
        this.$box = this.$element
    },
    b.prototype.initOnImage = function(b) {
        var c = a(b).css("float");
        "A" == a(b).parent().get(0).tagName && (b = a(b).parent()),
        this.isImage = !0,
        this.editableDisabled = !0,
        this.imageList = [],
        this.options.buttons = [],
    ...
    b.prototype.initOnDefault = function(b) {
        "DIV" != b.tagName && this.options.buttons.indexOf("formatBlock") >= 0 && this.disabledList.push("formatBlock"),
        this.$element = a(b)
    },
    b.prototype.initElement = function(b) {
        "TEXTAREA" == b.tagName ? this.initOnTextarea(b) : "A" == b.tagName ? this.initOnLink(b) : "IMG" == b.tagName ? this.initOnImage(b) : this.options.editInPopup ? this.initForPopup(b) : this.initOnDefault(b),
        this.editableDisabled || (this.$box = this.$element, this.$element = a("<div>"), this.setHTML(this.$box.html(), !1), this.$box.html(this.$element).addClass("froala-box"), this.$element.on("keyup", a.proxy(function(a) {
            var b = a.which;
        ...
        this.$element.on("drop", a.proxy(function() {
            setTimeout(a.proxy(function() {
                a("html").click(),
                this.$element.find(".f-img-wrap").each(function(b, c) {
    ...
    b.prototype.wrapTextInElement = function(b, c) {
        ...
        var g = function() {
            ...
            for (var e = 0; e < d.length; e++) {
                var g = a(d[e]);
                b.append(g.clone()),
                e == d.length - 1 ? g.replaceWith(b) : g.remove()
            }
            d = []
        },
        h = !1,
        ...
        b.contents().filter(function() {
            ...
            if (b.hasClass("f-marker") || b.find(".f-marker").length) {
                var j = b;
                b.find(".f-marker").length && (j = a(b.find(".f-marker")[0])),
                "true" === j.attr("data-type") ? (h = !0, i = !1) : i = !0
            }
        ...
        (h || c) && g(),
        b.find("> p").each(function(b, c) {
            0 === a(c).text().trim().length && 0 === a(c).find("img").length && 0 === a(c).find("br").length && a(c).append("<br/>")
        }),
        b.find("div:empty").remove(),
        b.is(":empty") && b.append(f.options.paragraphy === !0 ? "<p><br/></p>": "<br/>"),
        this.no_verify = !1
    },
    ...
    b.prototype.setHTML = function(b, c) {
        ...
        this.options.paragraphy && this.wrapText(!0),
        c === !0 && (this.restoreSelectionByMarkers(), this.sync()),
        this.$element.find("span").attr("data-fr-verified", !0),
        this.no_verify = !1
    },
    b.prototype.breakHTML = function(b) {
        if (this.removeMarkers(), this.insertHTML("<break></break>"), this.$element.find("break").remove(), this.checkPlaceholder(), this.$element.hasClass("f-placeholder")) return this.$element.html(b),
        !0;
        var c = this.getSelectionElements()[0];
        if (c == this.$element.get(0)) return this.insertHTML(b),
        !0;
        if (this.emptyElement(a(c))) return a(c).replaceWith(b),
        !0;
        this.insertHTML("<break></break>");
        for (var d, e, f = a("<div></div>").append(a(c).clone()).html(), g = [], h = {},
        i = [], j = 0, k = 0; k < f.length; k++) if (e = f.charAt(k), "<" == e) {
            var l = f.indexOf(">", k + 1);
            if ( - 1 !== l) {
                d = f.substring(k, l + 1);
        ...
        i.push(e);
        a(c).replaceWith(i.join("")),
        this.restoreSelectionByMarkers()
    },
    b.prototype.beforePaste = function() {
        this.saveSelectionByMarkers(),
        this.clipboardHTML = null,
        this.scrollPosition = a(window).scrollTop(),
        this.$pasteDiv = a('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; z-index: 99999;"></div>').appendTo("body"),
        this.$pasteDiv.focus(),
        window.setTimeout(a.proxy(this.processPaste, this), 1)
    },
    b.prototype.processPaste = function() {
        ...
        if ("string" == typeof d && (b = d), b = b.replace(/<img /gi, '<img data-fr-image-pasted="true" '), b.match(/(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/gi) ? c = this.wordClean(b) : (c = this.clean(b, !1, !0), c = this.removeEmptyTags(c)), this.options.plainPaste && (c = this.plainPasteClean(c)), "" !== c) {
            for (var e = !1,
            f = a("<div>").append(c).find("*"), g = 0; g < f.length; g++) if (a.Editable.VALID_NODES.indexOf(f[g].tagName) >= 0) {
                this.breakHTML(c),
                e = !0;
                break
            }
    ...
    b.prototype.afterPaste = function() {
        ...
        this.pasting = !1,
        this.triggerEvent("afterPaste", [], !0, !0)
    },
        ...
        if (b && b.clipboardData && b.clipboardData.items) {
            ...
            if (c) {
                ...
                return d.onload = a.proxy(function(a) {
                    ...
                    this.insertHTML('<img data-fr-image-pasted="true" src="' + b + '" />'),
                    this.afterPaste()
                },
                this),
                d.readAsDataURL(c),
    ...
    b.prototype.uploadPastedImages = function() {
        this.$element.find("img[data-fr-image-pasted]").each(a.proxy(function(b, c) {
            this.options.pasteImage ? (0 === c.src.indexOf("data:") ? this.options.pastedImagesUploadURL && (setTimeout(a.proxy(function() {
                ...
                this.showByCoordinates(a(c).offset().left + a(c).width() / 2, a(c).offset().top + a(c).height() + 10),
                this.isDisabled = !0
            },
            this), 10), a.ajax({
                ...
                try {
                    if (b.link) {
                        ...
                        d.onload = a.proxy(function() {
                            ...
                            this.hide(),
                            this.enable(),
                            this.triggerEvent("afterUploadPastedImage", [a(c)])
                        },
                        this),
                        d.src = b.link
    ...
    b.prototype.wordClean = function(a) {
        a = a.replace(/<p(.*?)class="?'?MsoListParagraph"?'?([\s\S]*?)>([\s\S]*?)<\/p>/gi, "<ul><li><p>$3</p></li></ul>"),
        a = a.replace(/<p(.*?)class="?'?MsoListParagraphCxSpFirst"?'?([\s\S]*?)>([\s\S]*?)<\/p>/gi, "<ul><li><p>$3</p></li>"),
        a = a.replace(/<p(.*?)class="?'?MsoListParagraphCxSpMiddle"?'?([\s\S]*?)>([\s\S]*?)<\/p>/gi, "<li><p>$3</p></li>"),
        a = a.replace(/<p(.*?)class="?'?MsoListParagraphCxSpLast"?'?([\s\S]*?)>([\s\S]*?)<\/p>/gi, "<li><p>$3</p></li></ul>"),
    ...
    b.prototype.cleanTags = function(a, b) {
        ...
        for (d = 0; d < a.length; d++) if (c = a.charAt(d), "<" == c) {
            ...
            if ( - 1 !== k) {
                ...
                else if (n) for (e = !1, f = !0; e === !1 && void 0 !== f;) f = h.pop(),
                void 0 !== f && f.tag_name !== m ? i.splice(f.i, 1) : (e = !0, void 0 !== f && i.push(l));
                else i.push(l),
                h.push({
                    tag_name: m,
                    i: i.length - 1
        ...
        for (; h.length > 0;) f = h.pop(),
        i.splice(f.i, 1);
        var o = "\n";
        this.options.beautifyCode || (o = ""),
        a = "",
        h = 0;
        var p = !0;
        ...
        return a[0] == o && (a = a.substring(1, a.length)),
        a[a.length - 1] == o && (a = a.substring(0, a.length - 1)),
        a
    },
    b.prototype.cleanupLists = function() {
        this.$element.find("ul, ol").each(function(b, c) {
            ...
            if (d.find(".close-ul, .open-ul, .close-ol, .open-ol, .open-li, .close-li").length > 0) {
                ...
                e = e.replace(new RegExp('<span class="close-ul" data-fr-verified="true"></span>', "g"), "</ul>"),
                e = e.replace(new RegExp('<span class="open-ul" data-fr-verified="true"></span>', "g"), "<ul>"),
                e = e.replace(new RegExp('<span class="close-ol" data-fr-verified="true"></span>', "g"), "</ol>"),
                e = e.replace(new RegExp('<span class="open-ol" data-fr-verified="true"></span>', "g"), "<ol>"),
                e = e.replace(new RegExp('<span class="close-li" data-fr-verified="true"></span>', "g"), "</li>"),
                e = e.replace(new RegExp('<span class="open-li" data-fr-verified="true"></span>', "g"), "<li>"),
                d.replaceWith(e)
            }
        });
        for (var b = this.$element.find("ol + ol, ul + ul"), c = 0; c < b.length; c++) {
            var d = a(b[c]);
            d.prev().append(d.html()),
            d.remove()
        }
    ...
    b.prototype.clean = function(b, c, d, e, f) {
        f || (f = a.merge([], this.options.allowedAttrs)),
        e || (e = a.merge([], this.options.allowedTags)),
        c || (f.indexOf("id") > -1 && f.splice(f.indexOf("id"), 1), f.indexOf("class") > -1 && f.splice(f.indexOf("class"), 1)),
    ...
    b.prototype.initElementStyle = function() {
        ...
        this.browser.msie && b.getIEversion() < 9 && (a += " ie8"),
        this.$element.css("outline", 0),
        this.browser.msie || (a += " not-msie"),
    ...
    b.prototype.getHTML = function(b, c) {
        ...
        this.$element.find("a").data("fr-link", !0),
        c && this.addFrTag(),
        this.$element.find(".f-img-editor > img").each(a.proxy(function(b, c) {
            this.addImageClass(a(c), this.getImageClass(a(c).parent().attr("class")))
        },
        this)),
        this.$element.find("pre").each(a.proxy(function(b, c) {
            var d = a(c),
            e = d.html(),
            f = e.replace(/\&nbsp;/gi, " ");
        ...
        return this.$element.find(".f-img-editor > img").removeClass("fr-fin fr-fil fr-fir"),
        this.$element.find("p, h1, h2, h3, h4, h5, h6, pre, blockquote, table, ul, ol, img").removeClass("fr-tag"),
        d = this.syncCleanHTML(d, b),
        d = d.replace(/<a[^>]*?><\/a>/g, ""),
        b || (d = this.removeMarkersByRegex(d)),
        d = d.replace(/<span[^>]*? class\s*=\s*["']?f-img-handle[^>]+><\/span>/gi, ""),
        d = d.replace(/^([\S\s]*)<span[^>]*? class\s*=\s*["']?f-img-editor[^>]+>([\S\s]*)<\/span>([\S\s]*)$/gi, "$1$2$3"),
        d = d.replace(/^([\S\s]*)<span[^>]*? class\s*=\s*["']?f-img-wrap[^>]+>([\S\s]*)<\/span>([\S\s]*)$/gi, "$1$2$3"),
        d = d.replace(/\&amp;/gi, "&"),
        this.options.simpleAmpersand && (d = d.replace(/\&amp;/gi, "&")),
        d = d.replace(/ data-fr-verified="true"/gi, ""),
        this.options.beautifyCode && (d = d.replace(/\n/gi, "")),
        d = d.replace(/\u200B/gi, "")
    },
    ...
    b.prototype.initAjaxSaver = function() {
        ...
        this.ajaxSave = !0,
        this.ajaxInterval = setInterval(a.proxy(function() {
            var a = this.getHTML();
            this.ajaxHTML != a && this.ajaxSave && (this.options.autosave && this.save(), this.ajaxHTML = a),
            this.ajaxSave = !0
        },
    ...
    b.prototype.disableBrowserUndo = function() {
        a("body").keydown(function(a) {
            ...
            if (!this.isHTML && c) {
                if (75 == b) return a.preventDefault(),
                !1;
                if (90 == b && a.shiftKey) return a.preventDefault(),
                !1;
                if (90 == b) return a.preventDefault(),
                !1
            }
        })
    },
    ...
    b.prototype.focus = function(c) {
        ...
        if (!this.isHTML) { ! c || this.pasting || this.browser.msie || this.$element.focus(),
            this.pasting && !this.$element.is(":focus") && this.$element.focus();
            var d = this.getRange();
    ...
    b.prototype.insertHTML = function(a, b) {
        ...
        if (this.no_verify = !0, window.getSelection) {
            if (c = window.getSelection(), c.getRangeAt && c.rangeCount) {
                ...
                d.insertNode(h),
                g && (d = d.cloneRange(), d.collapse(!1), c.removeAllRanges(), c.addRange(d))
            }
        } else if ((c = document.selection) && "Control" != c.type) {
            var i = c.createRange();
            i.collapse(!0),
            c.createRange().pasteHTML(a),
            selectPastedContent && (d = c.createRange(), d.setEndPoint("StartToStart", i), d.select())
        }
        this.no_verify = !1
    },
    ...
    b.prototype.initEditor = function() {
        var c = "froala-editor";
        this.isTouch() && (c += " touch"),
        this.browser.msie && b.getIEversion() < 9 && (c += " ie8"),
        this.$editor = a('<div class="' + c + '" style="display: none;">'),
        a("body").append(this.$editor),
    ...
    b.prototype.initBasicEditor = function() {
        ...
        this.$popup_editor.appendTo(a("body")).addClass("f-inline"),
    ...
    b.prototype.initOptions = function() {
        ...
        this.setZIndex(),
        this.setTheme(),
        this.options.editInPopup && this.buildEditPopup()
    },
    ...
    b.prototype.initEditorSelection = function() {
        ...
        this)),
        this.options.disableRightClick && this.$element.contextmenu(a.proxy(function(a) {
            return a.preventDefault(),
            this.options.inlineMode && this.$element.focus(),
            !1
        },
        this)),
        this.$element.on("mouseup touchend", a.proxy(function(b) {
            if (this.isDisabled) return ! 1;
            if (!this.isResizing()) {
                var c = this.text();
                b.stopPropagation(),
                !("" !== c || this.options.alwaysVisible || this.options.editInPopup || (3 == b.which || 2 == b.button) && this.options.inlineMode && !this.isImage && this.options.disableRightClick) || this.link || this.imageMode ? this.options.inlineMode || this.refreshButtons() : setTimeout(a.proxy(function() {
                    c = this.text(),
                    !("" !== c || this.options.alwaysVisible || this.options.editInPopup || (3 == b.which || 2 == b.button) && this.options.inlineMode && !this.isImage && this.options.disableRightClick) || this.link || this.imageMode || (this.show(b), this.options.editInPopup && this.showEditPopup())
                },
                this), 20),
                this.imageMode = !1
            }
        ...
        this)),
        this.$editor.on("mouseup", a.proxy(function(a) {
            return this.isDisabled ? !1 : void(this.isResizing() || (a.stopPropagation(), this.options.inlineMode === !1 && this.hide()))
        },
        this)),
        this.$editor.on("mousedown", ".fr-dropdown-menu", a.proxy(function(a) {
            return this.isDisabled ? !1 : (a.stopPropagation(), void(this.noHide = !0))
        },
        this)),
        this.$popup_editor.on("mousedown", ".fr-dropdown-menu", a.proxy(function(a) {
            return this.isDisabled ? !1 : (a.stopPropagation(), void(this.noHide = !0))
        },
        this)),
        this.$popup_editor.on("mouseup", a.proxy(function(a) {
            return this.isDisabled ? !1 : void(this.isResizing() || a.stopPropagation())
        },
        this)),
        this.$edit_popup_wrapper && this.$edit_popup_wrapper.on("mouseup", a.proxy(function(a) {
            return this.isDisabled ? !1 : void(this.isResizing() || a.stopPropagation())
        },
        this)),
        ...
        this.options.trackScroll && this.setWindowScrollEvent()
    },
    ...
    b.prototype.setWindowKeyDownEvent = function() {
        this.$window.on("keydown." + this._id, a.proxy(function(b) {
            var c = b.which;
            if (this.imageMode) {
                if (13 == c) return this.$element.find(".f-img-editor").parents(".f-img-wrap").before("<br/>"),
                this.sync(),
                this.$element.find(".f-img-editor img").click(),
                !1;
                if (46 == c || 8 == c) return b.stopPropagation(),
                b.preventDefault(),
                setTimeout(a.proxy(function() {
                ...
                var d = (b.ctrlKey || b.metaKey) && !b.altKey; ! d && this.$popup_editor.is(":visible") && (27 == c || this.$bttn_wrapper.is(":visible") && this.options.inlineMode) && (this.hide(), this.closeImageMode())
            }
        },
        this))
    },
    ...
    b.prototype.setTextNearImage = function(a) {
        void 0 !== a && (this.options.textNearImage = a),
        this.options.textNearImage === !0 ? this.$element.removeClass("f-tni") : this.$element.addClass("f-tni")
    },
    ...
    b.prototype.setDimensions = function(a, b, c, d) {
        a && (this.options.height = a),
        b && (this.options.width = b),
        c && (this.options.minHeight = c),
        d && (this.options.maxHeight = d),
        "auto" != this.options.height && this.$element.css("height", this.options.height),
        "auto" != this.options.minHeight && this.$element.css("minHeight", this.options.minHeight),
        "auto" != this.options.maxHeight && this.$element.css("maxHeight", this.options.maxHeight),
        "auto" != this.options.width && this.$box.css("width", this.options.width)
    },
    b.prototype.setDirection = function(a) {
        a && (this.options.direction = a),
        "ltr" != this.options.direction && "rtl" != this.options.direction && (this.options.direction = "ltr"),
        "rtl" == this.options.direction ? (this.$element.addClass("f-rtl"), this.$editor.addClass("f-rtl"), this.$popup_editor.addClass("f-rtl"), this.$image_modal && this.$image_modal.addClass("f-rtl")) : (this.$element.removeClass("f-rtl"), this.$editor.removeClass("f-rtl"), this.$popup_editor.removeClass("f-rtl"), this.$image_modal && this.$image_modal.removeClass("f-rtl"))
    },
    b.prototype.setZIndex = function(a) {
        a && (this.options.zIndex = a),
        this.$editor.css("z-index", this.options.zIndex),
        this.$popup_editor.css("z-index", this.options.zIndex + 1),
        this.$overlay && this.$overlay.css("z-index", this.options.zIndex + 2),
        this.$image_modal && this.$image_modal.css("z-index", this.options.zIndex + 3)
    },
    b.prototype.setTheme = function(a) {
        a && (this.options.theme = a),
        null != this.options.theme && (this.$editor.addClass(this.options.theme + "-theme"), this.$popup_editor.addClass(this.options.theme + "-theme"), this.$box && this.$box.addClass(this.options.theme + "-theme"), this.$image_modal && this.$image_modal.addClass(this.options.theme + "-theme"))
    },
    b.prototype.setSpellcheck = function(a) {
        void 0 !== a && (this.options.spellcheck = a),
    ...
    b.prototype.customizeText = function(b) {
        if (b) {
            ...
            this.$image_modal && (c = c.add(this.$image_modal.find("[title]"))),
            c.each(a.proxy(function(c, d) {
                for (var e in b) a(d).attr("title").toLowerCase() == e.toLowerCase() && a(d).attr("title", b[e])
            },
            this)),
            c = this.$editor.find('[data-text="true"]').add(this.$popup_editor.find('[data-text="true"]')),
            this.$image_modal && (c = c.add(this.$image_modal.find('[data-text="true"]'))),
            c.each(a.proxy(function(c, d) {
    ...
    b.prototype.initHTMLArea = function() {
        this.$html_area = a('<textarea wrap="hard">').keydown(function(b) {
            ...
            if (9 == c) {
                ...
                a(this).val(a(this).val().substring(0, d) + "	" + a(this).val().substring(e)),
                a(this).get(0).selectionStart = a(this).get(0).selectionEnd = d + 1
            }
    ...
    b.prototype.command_dispatcher = {
        ...
        html: function(b) {
            ...
            return this.options.inlineMode && this.$box.append(a(c).clone(!0).addClass("html-switch").attr("title", "Hide HTML").click(a.proxy(this.execHTML, this))),
            this.initHTMLArea(),
            c
        }
    },
    b.prototype.setButtons = function(a) {
        ...
        this.isTouch() && this.$bttn_wrapper.addClass("touch");
        for (var c, d, e = "",
        f = 0; f < this.options.buttons.length; f++) {
            ...
            if ("sep" != g) {
                ...
                if (void 0 !== h) {
                    ...
                    if (h = this.options.customButtons[g], void 0 === h) {
                        ...
                        d = this.buildCustomDropdown(h, g),
                        e += d,
                        this.bindRefreshListener(h);
                        continue
                    }
                    d = this.buildCustomButton(h, g),
                    e += d,
                    this.bindRefreshListener(h)
                }
            } else e += this.options.inlineMode ? '<div class="f-clear"></div><hr/>': '<span class="f-sep"></span>'
        }
        this.$bttn_wrapper.html(e),
    ...
    b.prototype.buildDefaultButton = function(a) {
        ...
        return b += void 0 === this.options.icons[a.cmd] ? this.addButtonIcon(a) : this.prepareIcon(this.options.icons[a.cmd], a.title),
        b += "</button>"
    },
    ...
    b.prototype.buildCustomDropdown = function(a, b) {
        ...
        c += '<button type="button" class="fr-trigger" title="' + a.title + '" data-name="' + b + '">' + this.prepareIcon(a.icon, a.title) + "</button>",
        c += '<ul class="fr-dropdown-menu">';
        var d = 0;
        for (var e in a.options) {
            var f = '<li data-name="' + b + d + '"><a href="#">' + e + "</a></li>";
            this.callDropdown(b + d, a.options[e]),
            c += f,
            d++
        }
        return c += "</ul></div>"
    ...
    b.prototype.buildDropdownAlign = function(a) {
        ...
        for (var b = '<ul class="fr-dropdown-menu f-align">',
        c = 0; c < a.seed.length; c++) {
            var d = a.seed[c];
    ...
    b.prototype.buildDropdownFormatBlock = function(b) {
        for (var c = '<ul class="fr-dropdown-menu">',
        d = 0; d < b.seed.length; d++) {
            var e = b.seed[d];
            if ( - 1 != a.inArray(e.value, this.options.blockTags)) {
                var f = '<li data-cmd="' + b.cmd + '" data-val="' + e.value + '">';
                f += '<a href="#" data-text="true" class="format-' + e.value + '" title="' + e.title + '">' + e.title + "</a></li>",
                c += f
            }
        }
        return c += "</ul>"
    ...
    b.prototype.buildDefaultDropdown = function(a) {
        for (var b = '<ul class="fr-dropdown-menu">',
        c = 0; c < a.seed.length; c++) {
            var d = a.seed[c],
            e = '<li data-cmd="' + (d.cmd || a.cmd) + '" data-val="' + d.value + '" data-param="' + (d.param || a.param) + '">';
            e += '<a href="#" data-text="true" class="' + d.value + '" title="' + d.title + '">' + d.title + "</a></li>",
            b += e
        }
        return b += "</ul>"
    },
    b.prototype.createEditPopupHTML = function() {
        ...
        return a += '<h4><span data-text="true">Edit text</span><i title="Cancel" class="fa fa-times" id="f-text-close-' + this._id + '"></i></h4></h4>',
        a += '<div class="f-popup-line"><input type="text" placeholder="http://www.example.com" class="f-lu" id="f-ti-' + this._id + '">',
        a += '<button data-text="true" type="button" class="f-ok" id="f-edit-popup-ok-' + this._id + '">OK</button>',
        a += "</div>",
        a += "</div>"
    },
    b.prototype.buildEditPopup = function() {
        this.$edit_popup_wrapper = a(this.createEditPopupHTML()),
        this.$popup_editor.append(this.$edit_popup_wrapper),
        this.$edit_popup_wrapper.find("#f-ti-" + this._id).on("mouseup keydown",
        function(a) {
            a.stopPropagation()
        }),
        ...
        this)),
        this.$edit_popup_wrapper.on("click", "i#f-text-close-" + this._id, a.proxy(function() {
            this.hide()
        },
        this))
    },
    ...
    b.prototype.bindButtonEvents = function() {
        this.isTouch() ? (this.mousedown = "touchstart", this.mouseup = "touchend", this.move = "touchmove") : (this.mousedown = "click mousedown", this.mouseup = "mouseup", this.move = ""),
        this.bindDropdownEvents(),
        this.bindCommandEvents()
    },
    b.prototype.bindDropdownEvents = function() {
        var c = this;
        this.$bttn_wrapper.on(this.mousedown, ".fr-dropdown .fr-trigger:not([disabled])",
        function(b) {
            b.preventDefault(),
            a(this).attr("data-down", !0)
        }),
        this.$bttn_wrapper.on(this.mouseup, ".fr-dropdown .fr-trigger:not([disabled])",
        function(d) {
            if (c.isDisabled) return ! 1;
            if (d.stopPropagation(), d.preventDefault(), !a(this).attr("data-down")) return a("[data-down]").removeAttr("data-down"),
            !1;
            a("[data-down]").removeAttr("data-down"),
            "touchend" === d.type && c.android() && (c.saveSelectionByMarkers(), setTimeout(function() {
                c.restoreSelectionByMarkers()
            },
            10)),
            c.options.inlineMode === !1 && c.hide(),
            a(this).toggleClass("active").trigger("blur"),
            c.closeImageMode(),
            c.imageMode = !1;
            var e, f = a(this).attr("data-name");
            b.commands[f] ? e = b.commands[f].refreshOnShow: c.options.customDropdowns[f] && (e = c.options.customDropdowns[f].refreshOnShow),
            e && e.call(c),
            c.$bttn_wrapper.find(".fr-dropdown").not(a(this).parent()).find(".fr-trigger").removeClass("active")
        }),
        ...
        this)),
        this.$bttn_wrapper.on("click", "li[data-cmd] > a",
        function(a) {
            a.preventDefault()
        })
    },
    b.prototype.bindCommandEvents = function() {
        var b = this;
        this.$bttn_wrapper.on(this.mousedown, "button[data-cmd], li[data-cmd], span[data-cmd], a[data-cmd]",
        function(c) {
        ...
        this.$bttn_wrapper.on(this.mouseup + " " + this.move, "button[data-cmd], li[data-cmd], span[data-cmd], a[data-cmd]", a.proxy(function(c) {
            ...
            if ("touchmove" != c.type) {
                if (c.stopPropagation(), c.preventDefault(), !a(d).attr("data-down")) return a("[data-down]").removeAttr("data-down"),
                !1;
                if (a("[data-down]").removeAttr("data-down"), a(d).data("dragging")) return a(d).removeData("dragging"),
                !1;
                var e = a(d).data("cmd"),
                f = a(d).data("val"),
                g = a(d).data("param");
                return "touchend" == c.type && b.android() && (this.saveSelectionByMarkers(), this.restoreSelectionByMarkers()),
                b.exec(e, f, g),
                b.$bttn_wrapper.find(".fr-dropdown .fr-trigger").removeClass("active"),
                !1
            }
            a(d).data("dragging", !0)
        },
    ...
    b.prototype.undo = function() {
        if (this.no_verify = !0, this.undoIndex > 1) {
            ...
            this.$element.html(b),
            this.restoreSelectionByMarkers(),
            this.triggerEvent("undo", [this.getHTML(), a]),
            "" !== this.text() ? this.repositionEditor() : this.hide(),
            this.$element.trigger("placeholderCheck"),
            this.focus(),
            this.refreshButtons()
        }
    ...
    b.prototype.redo = function() {
        if (this.no_verify = !0, this.undoIndex < this.undoStack.length) {
            ...
            this.$element.html(b),
            this.restoreSelectionByMarkers(),
            this.triggerEvent("redo", [this.getHTML(), a]),
            "" !== this.text() ? this.repositionEditor() : this.hide(),
            this.$element.trigger("placeholderCheck"),
            this.focus(),
            this.refreshButtons()
    ...
    b.prototype.option = function(b, c) {
        ...
        if (b instanceof Object) this.options = a.extend({},
        this.options, b),
        this.initOptions(),
        this.setCustomText(),
        this.setLanguage();
    ...
    a.fn.editable.Constructor = b,
    a.Editable = b,
    a.fn.editable.noConflict = function() {
        return a.fn.editable = c,
        this
    }
} (window.jQuery),
function(a) {
    ...
    a.Editable.prototype.refreshFormatBlocks = function() {
        ...
        this.options.paragraphy && "p" === b && (b = "n"),
        this.$editor.find('.fr-bttn > button[data-name="formatBlock"] + ul li').removeClass("active"),
        this.$bttn_wrapper.find('.fr-bttn > button[data-name="formatBlock"] + ul li[data-val="' + b + '"]').addClass("active")
    },
    a.Editable.prototype.refreshUndo = function() {
        if (this.isEnabled("undo")) {
            ...
            (0 === this.undoStack.length || this.undoIndex <= 1 || this.isHTML) && this.$bttn_wrapper.find('[data-cmd="undo"]').prop("disabled", !0)
        }
    },
    ...
    a.Editable.prototype.refreshAlign = function() {
        ...
        var c = "justifyCenter",
        d = b.css("text-align");
        "left" == d ? c = "justifyLeft": "right" == d ? c = "justifyRight": "justify" == d && (c = "justifyFull"),
        this.$editor.find('.fr-dropdown > button[data-name="align"].fr-trigger i').attr("class", "fa fa-align-" + d),
        this.$editor.find('.fr-dropdown > button[data-name="align"] + ul li[data-cmd="' + c + '"]').addClass("active")
    },
...
function(a) {
    ...
    a.Editable.prototype.exec = function(b, c, d) {
        return this.selectionInEditor() || this.focus(),
        this.selectionInEditor() && "" === this.text() && a.Editable.commands[b].callbackWithoutSelection ? (a.Editable.commands[b].callbackWithoutSelection.apply(this, [b, c, d]), !1) : (a.Editable.commands[b].callback ? a.Editable.commands[b].callback.apply(this, [b, c, d]) : this.execDefault(b, c), void(a.Editable.commands[b].undo && this.saveUndoStep()))
    },
    ...
    a.Editable.prototype.formatBlock = function(b, c, d) {
        ...
        if (this.browser.msie && a.Editable.getIEversion() < 9) return document.execCommand("formatBlock", !1, "<" + b + ">"),
        !1;
        this.saveSelectionByMarkers(),
        this.wrapText(),
        this.restoreSelectionByMarkers();
        var e = this.getSelectionElements();
        e[0] == this.$element.get(0) && (e = this.$element.find("> " + a.Editable.VALID_NODES.join(", >"))),
        this.saveSelectionByMarkers();
        ...
        h = 0; h < e.length; h++) {
            ...
            if (!this.fakeEmpty(i)) if (f = "n" == b ? this.options.paragraphy ? a("<p>").html(i.html()) : i.html() + "<br/>": a("<" + b + ">").html(i.html()), i.get(0) == this.$element.get(0) || g(f)) i.html(f);
                ...
                var l;
                this.options.blockStyles && this.options.blockStyles[b],
                void 0 === l && (l = this.options.defaultBlockStyle);
                try {
                    if (i.hasClass(c) && i.get(0).tagName.toLowerCase() === b) f.addClass(i.attr("class")).removeClass(c);
                        ...
                        if (void 0 === i.attr("class") || void 0 === l || !this.options.blockStylesToggle && "toggle" != d) f.addClass(i.attr("class"));
                            ...
                            var o = m[n];
                            void 0 === l[o] && void 0 === d ? f.addClass(o) : void 0 !== l[o] && "toggle" === d && f.addClass(o),
                            i.get(0).tagName.toLowerCase() !== b && void 0 !== l[o] && f.addClass(o)
                        }
                        "*" != c && f.addClass(c)
                    }
                } catch(p) {}
    ...
    a.Editable.prototype.align = function(b) {
        if (this.browser.msie && a.Editable.getIEversion() < 9) return document.execCommand(b, !1, !1),
        !1;
        this.saveSelectionByMarkers();
        ...
        this.repositionEditor(),
        this.restoreSelectionByMarkers(),
        this.triggerEvent("align", [b])
    },
    a.Editable.prototype.indent = function(b) {
        if (this.browser.msie && a.Editable.getIEversion() < 9) return b ? document.execCommand("outdent", !1, !1) : document.execCommand("indent", !1, !1),
        !1;
        var c = 20;
        b && (c = -20),
        this.saveSelectionByMarkers(),
        ...
        for (var e = 0; e < d.length; e++) {
            ...
            if (f.parentsUntil(this.$element, "li").length > 0 && (f = f.closest("li")), "LI" === f.get(0).tagName && a.isFunction(this.indentLi)) b ? this.outdentLi(f) : this.indentLi(f);
                ...
                f.html(i),
                i.css("marginLeft", Math.max(0, c))
            }
        }
        this.unwrapText(),
        this.restoreSelectionByMarkers(),
        this.repositionEditor(),
        b || this.triggerEvent("indent")
    },
    ...
    a.Editable.prototype.execDefault = function(a, b) {
        ...
        this.triggerEvent(a, [], !0, !0)
    },
    a.Editable.prototype._startInDefault = function(a) {
        this.focus(),
        document.execCommand(a, !1, !0),
        this.refreshButtons()
    },
    a.Editable.prototype._startInFontExec = function(b, c, d) {
        ...
        try {
            ...
            f.insertNode(g[0]),
            g = this.$element.find("[data-inserted]"),
            g.removeAttr("data-inserted"),
            this.setSelection(g.get(0), 1)
        } catch(h) {}
    },
    a.Editable.prototype.removeFormat = function() {
        document.execCommand("removeFormat", !1, !1),
        document.execCommand("unlink", !1, !1)
    },
    a.Editable.prototype.inlineStyle = function(b, c, d) {
        ...
        document.execCommand("fontSize", !1, 4),
        this.saveSelectionByMarkers(),
        this.browser.webkit && "font-size" != b && this.$element.find("span").each(function(b, c) {
            var d = a(c);
...
function(a) {
    a.Editable.prototype.text = function() {
        var a = "";
        return window.getSelection ? a = window.getSelection() : document.getSelection ? a = document.getSelection() : document.selection && (a = document.selection.createRange().text),
        a.toString()
    },
    a.Editable.prototype.selectionInEditor = function() {
        var b = this.getSelectionParent(),
        c = !1;
        return b == this.$element.get(0) && (c = !0),
        c === !1 && a(b).parents().each(a.proxy(function(a, b) {
    ...
    a.Editable.prototype.getSelectionElement = function() {
        ...
        if (b.rangeCount) {
            ...
            var e = !1;
            d.children.length > 0 && d.children[c.startOffset] && a(d.children[c.startOffset]).text() === this.text() && (d = d.children[c.startOffset], e = !0),
            !e && d.children.length > 0 && a(d.children[0]).text() === this.text() && ["BR", "IMG"].indexOf(d.children[0].tagName) < 0 && (d = d.children[0]);
    ...
    a.Editable.prototype.getSelectionParent = function() {
        var b, c = null;
        return window.getSelection ? (b = window.getSelection(), b.rangeCount && (c = b.getRangeAt(0).commonAncestorContainer, 1 != c.nodeType && (c = c.parentNode))) : (b = document.selection) && "Control" != b.type && (c = b.createRange().parentElement()),
        null != c && (a.inArray(this.$element.get(0), a(c).parents()) >= 0 || c == this.$element.get(0)) ? c: null
    },
    ...
    a.Editable.prototype.getRangeSelectedNodes = function(a) {
        ...
        if (c == d && "TR" != c.tagName) {
            if (c.hasChildNodes() && 0 !== c.children.length) {
                ...
                f = a.startOffset; f < a.endOffset; f++) e[f] && b.push(e[f]);
                return 0 === b.length && b.push(c),
                b
            }
            return [c]
        }
        ...
        for (c = a.startContainer; c && c != a.commonAncestorContainer;) b.unshift(c),
        c = c.parentNode;
        return b
    },
    ...
    a.Editable.prototype.getSelectionElements = function() {
        ...
        this)),
        0 === c.length && c.push(this.$element.get(0)),
        c
    },
    ...
    a.Editable.prototype.insertMarkersAtPoint = function(a) {
        ...
        this.placeMarker(e, !0, 0),
        this.placeMarker(e, !1, 0)
    },
    a.Editable.prototype.saveSelectionByMarkers = function() {
        if (!this.selectionDisabled) {
            ...
            var a = this.getRanges();
            this.removeMarkers();
            for (var b = 0; b < a.length; b++) this.placeMarker(a[b], !0, b),
            this.placeMarker(a[b], !1, b)
        }
    },
    ...
    a.Editable.prototype.restoreSelectionByMarkers = function(b) {
        if (void 0 === b && (b = !0), !this.selectionDisabled) {
            ...
            var d = this.getSelection(); ! b && 1 === c.length && 1 === d.rangeCount && this.getRange().collapsed && a(c[0]).attr("data-collapsed") || (this.clearSelection(), b = !0);
    ...
    a.Editable.prototype.buildMarker = function(b, c, d) {
        return void 0 === d && (d = ""),
        a('<span class="f-marker"' + d + ' style="display:none; line-height: 0;" data-fr-verified="true" data-id="' + c + '" data-type="' + b + '">', document)[0]
    },
    a.Editable.prototype.placeMarker = function(a, b, c) {
        try {
            ...
            d.collapse(b);
            var e = "";
            a.collapsed && (e = ' data-collapsed="true"'),
            d.insertNode(this.buildMarker(b, c, e))
        } catch(f) {}
        return null
    },
...
function(a) {
    ...
    a.Editable.browser = function() {
        ...
        if (this.getIEversion() > 0) a.msie = !0;
            ...
            c[1] && (a[d.browser] = !0),
            parseInt(d.version, 10) < 9 && a.msie && (a.oldMsie = !0),
    ...
    a.Editable.prototype.show = function(b) {
        if (void 0 !== b) {
            if (this.options.inlineMode || this.options.editInPopup) if (null !== b && "touchend" !== b.type) {
                var c = b.pageX,
                d = b.pageY;
                c < this.$element.offset().left && (c = this.$element.offset().left),
                c > this.$element.offset().left + this.$element.width() && (c = this.$element.offset().left + this.$element.width()),
                d < this.$element.offset.top && (d = this.$element.offset().top),
                d > this.$element.offset().top + this.$element.height() && (d = this.$element.offset().top + this.$element.height()),
                20 > c && (c = 20),
                0 > d && (d = 0),
                this.showByCoordinates(c, d),
                a(".froala-editor:not(.f-basic)").hide(),
                this.$editor.show(),
                0 !== this.options.buttons.length || this.options.editInPopup || this.$editor.hide()
            } else a(".froala-editor:not(.f-basic)").hide(),
            this.$editor.show(),
            this.repositionEditor();
            this.hidePopups(),
            this.options.editInPopup || this.showEditPopupWrapper(),
...
function(a) {
    a.Editable.prototype.getBoundingRect = function() {
        ...
        if (this.isLink) {
            b = {};
            var c = this.$element;
            b.left = c.offset().left - a(window).scrollLeft(),
            b.top = c.offset().top - a(window).scrollTop(),
            b.width = c.outerWidth(),
            b.height = parseInt(c.css("padding-top").replace("px", ""), 10) + c.height(),
            b.right = 1,
            b.bottom = 1,
            b.ok = !0
            ...
            e.css("display", "none"),
            b = {},
            b.left = f.left - a(window).scrollLeft(),
            b.width = 0,
            b.height = (parseInt(d.css("line-height").replace("px", ""), 10) || 10) - 10 - a(window).scrollTop(),
            b.top = f.top,
            b.right = 1,
            b.bottom = 1,
            b.ok = !0,
    ...
    a.Editable.prototype.repositionEditor = function(b) {
        ...
        if (this.options.inlineMode || b) {
            if (c = this.getBoundingRect(), this.showBttnWrapper(), c.ok || c.left >= 0 && c.top >= 0 && c.right > 0 && c.bottom > 0) d = c.left + c.width / 2,
            e = c.top + c.height,
            d += a(window).scrollLeft(),
            e += a(window).scrollTop(),
            this.showByCoordinates(d, e);
...
function(a) {
    ...
    a.Editable.prototype.showImageEditorPopup = function() {
        this.$image_editor && this.$image_editor.show(),
        this.options.imageMove || this.$element.attr("contenteditable", !1)
    },
    ...
    a.Editable.prototype.insertImageHTML = function() {
        ...
        return b += '<div id="f-image-list-' + this._id + '">',
        this.options.imageUpload && (b += '<div class="f-popup-line drop-upload">', b += '<div class="f-upload" id="f-upload-div-' + this._id + '"><strong data-text="true">Drop Image</strong><br>(<span data-text="true">or click</span>)<form target="frame-' + this._id + '" enctype="multipart/form-data" encoding="multipart/form-data" action="' + this.options.imageUploadURL + '" method="post" id="f-upload-form-' + this._id + '"><input id="f-file-upload-' + this._id + '" type="file" name="' + this.options.imageUploadParam + '" accept="image/*"></form></div>', this.browser.msie && a.Editable.getIEversion() <= 9 && (b += '<iframe id="frame-' + this._id + '" name="frame-' + this._id + '" src="javascript:false;" style="width:0; height:0; border:0px solid #FFF; position: fixed; z-index: -1;"></iframe>'), b += "</div>"),
        this.options.imageLink && (b += '<div class="f-popup-line"><label><span data-text="true">Enter URL</span>: </label><input id="f-image-url-' + this._id + '" type="text" placeholder="http://example.com"><button class="f-browse" id="f-browser-' + this._id + '"><i class="fa fa-search"></i></button><button data-text="true" class="f-ok" id="f-image-ok-' + this._id + '">OK</button></div>'),
        b += "</div>",
        b += '<p class="f-progress" id="f-progress-' + this._id + '"><span></span></p>',
        b += "</div>"
    },
    a.Editable.prototype.iFrameLoad = function() {
        var a = this.$image_wrapper.find("iframe#frame-" + this._id);
        if (!a.attr("data-loaded")) return a.attr("data-loaded", !0),
        !1;
        try {
            ...
            if (this.options.imageUploadToS3) {
                ...
                e = c + d;
                this.writeImage(e),
                this.options.imageUploadToS3.callback && this.options.imageUploadToS3.callback.call(this, e, d)
            } else {
    ...
    a.Editable.prototype.initImage = function() {
        ...
        (!this.isLink || this.isImage) && (this.initImageEvents(), this.initImagePopup()),
        this.addListener("destroy", this.destroyImage)
    },
    a.Editable.initializers.push(a.Editable.prototype.initImage),
    a.Editable.prototype.destroyImage = function() {
    ...
    a.Editable.prototype.buildInsertImage = function() {
        this.$image_wrapper = a(this.insertImageHTML()),
        ...
        this)), this.addListener("hidePopups", a.proxy(function() {
            ...
            this.$image_wrapper.on("change", 'input[type="file"]',
            function() {
                if (void 0 !== this.files) b.uploadImage(this.files);
                    ...
                    if (b.options.imageUploadToS3 !== !1) {
                        ...
                        c.prepend('<input type="hidden" name="success_action_status" value="201" />'),
                        c.prepend('<input type="hidden" name="X-Requested-With" value="xhr" />'),
                        c.prepend('<input type="hidden" name="Content-Type" value="" />'),
                        c.prepend('<input type="hidden" name="key" value="' + b.options.imageUploadToS3.keyStart + (new Date).getTime() + "-" + a(this).val().match(/[^\/\\]+$/) + '" />')
        ...
        this)),
        this.$image_wrapper.on("click", "#f-image-ok-" + this._id, a.proxy(function() {
            this.writeImage(this.$image_wrapper.find("#f-image-url-" + this._id).val(), !0)
        },
        this)),
        this.$image_wrapper.on("click", "#f-image-close-" + this._id, a.proxy(function() {
    ...
    a.Editable.prototype.deleteImage = function(b) {
        if (this.options.imageDeleteURL) {
            ...
            a.ajax({
                ...
                b.parent().parent().hasClass("f-image-list") ? b.parent().remove() : b.parent().removeClass("f-img-deleting"),
                this.triggerEvent("imageDeleteSuccess", [a], !1)
            },
            this)).fail(a.proxy(function() {
                b.parent().removeClass("f-img-deleting"),
                this.triggerEvent("imageDeleteError", ["Error during image delete."], !1)
            },
            this))
        } else b.parent().removeClass("f-img-deleting"),
        this.triggerEvent("imageDeleteError", ["Missing imageDeleteURL option."], !1)
    },
    a.Editable.prototype.imageHandle = function() {
        ...
        c = a('<span data-fr-verified="true">').addClass("f-img-handle").on({
            movestart: function(c) {
                b.hide(),
                b.$element.addClass("f-non-selectable").attr("contenteditable", !1),
                b.$element.attr("data-resize", !0),
                a(this).attr("data-start-x", c.startX),
                a(this).attr("data-start-y", c.startY)
            },
            move: function(c) {
                var d = a(this),
                e = c.pageX - parseInt(d.attr("data-start-x"), 10);
                d.attr("data-start-x", c.pageX),
                d.attr("data-start-y", c.pageY);
                var f = d.prevAll("img"),
                g = f.width();
                d.hasClass("f-h-ne") || d.hasClass("f-h-se") ? f.attr("width", g + e) : f.attr("width", g - e),
                b.triggerEvent("imageResize", [], !1)
            },
            moveend: function() {
                a(this).removeAttr("data-start-x"),
                a(this).removeAttr("data-start-y"),
                b.$element.removeClass("f-non-selectable"),
                b.isImage || b.$element.attr("contenteditable", !0),
                b.triggerEvent("imageResizeEnd"),
                b.saveUndoStep(),
                a(this).trigger("mouseup")
            },
            touchend: function() {
    ...
    a.Editable.prototype.initImageEvents = function() {
        ...
        this.$element.on("click touchend", 'img:not([contenteditable="false"])',
        function(c) {
            if (b.isDisabled) return ! 1;
            if (!b.isResizing()) {
                c.preventDefault(),
                ...
                b.closeImageMode(),
                b.$element.blur(),
                b.$image_editor.find("button").removeClass("active");
                ...
                if (a(this).hasClass("fr-fil") ? d = "left": a(this).hasClass("fr-fir") && (d = "right"), b.$image_editor.find('button[data-cmd="floatImage' + d.charAt(0).toUpperCase() + d.slice(1) + '"]').addClass("active"), b.$image_editor.find('.f-image-alt input[type="text"]').val(a(this).attr("alt") || a(this).attr("title")), b.showImageEditor(), !a(this).parent().hasClass("f-img-editor") || "SPAN" != a(this).parent().get(0).tagName) {
                    ...
                    a(this).wrap('<span data-fr-verified="true" class="f-img-editor ' + e + '"></span>'),
                    0 !== a(this).parents(".f-img-wrap").length || b.isImage ? b.addImageClass(a(this).parents(".f-img-wrap"), e) : a(this).parents("a").length > 0 ? a(this).parents("a:first").wrap('<span data-fr-verified="true" class="f-img-wrap ' + e + '"></span>') : a(this).parent().wrap('<span data-fr-verified="true" class="f-img-wrap ' + e + '"></span>')
                }
                var f = b.imageHandle();
                a(this).parent().find(".f-img-handle").remove(),
                b.options.imageResize && (a(this).parent().append(f.clone(!0).addClass("f-h-ne")), a(this).parent().append(f.clone(!0).addClass("f-h-se")), a(this).parent().append(f.clone(!0).addClass("f-h-sw")), a(this).parent().append(f.clone(!0).addClass("f-h-nw"))),
                b.showByCoordinates(a(this).offset().left + a(this).width() / 2, a(this).offset().top + a(this).height()),
                b.imageMode = !0,
                b.$bttn_wrapper.find(".fr-bttn").removeClass("active"),
                b.clearSelection()
            }
        }),
        ...
        this)),
        this.$element.on("mouseup", ".f-img-handle", a.proxy(function(c) {
            if (b.isDisabled) return ! 1;
    ...
    a.Editable.prototype.initImagePopup = function() {
        ...
        for (var b = a('<div class="f-popup-line f-popup-toolbar">').appendTo(this.$image_editor), c = 0; c < this.options.imageButtons.length; c++) {
            ...
            if (void 0 !== a.Editable.image_commands[d]) {
                ...
                f += void 0 !== this.options.icons[d] ? this.prepareIcon(this.options.icons[d], e.title) : this.prepareIcon(e.icon, e.title),
                f += "</button>",
                b.append(f)
            }
        }
        this.addListener("hidePopups", this.hideImageEditorPopup),
        this.options.imageTitle && a('<div class="f-popup-line f-image-alt">').append('<label><span data-text="true">Title</span>: </label>').append(a('<input type="text">').on("mouseup keydown",
        function(a) {
            var b = a.which;
            b && 27 === b || a.stopPropagation()
        ...
        this.$image_editor.find("button").click(function(b) {
            b.stopPropagation(),
            g[a(this).attr("data-cmd")](g.$element.find("span.f-img-editor"))
        }),
        this.$popup_editor.append(this.$image_editor)
    },
    a.Editable.prototype.floatImageLeft = function(a) {
        this.addImageClass(a, "fr-fil"),
        this.isImage && this.$element.css("float", "left"),
        this.saveUndoStep(),
        this.triggerEvent("imageFloatedLeft"),
        a.find("img").click()
    },
    a.Editable.prototype.floatImageNone = function(a) {
        this.addImageClass(a, "fr-fin"),
        this.isImage || (a.parent().get(0) == this.$element.get(0) ? a.wrap('<div style="text-align: center;"></div>') : a.parents(".f-img-wrap:first").css("text-align", "center")),
        this.isImage && this.$element.css("float", "none"),
        this.saveUndoStep(),
        this.triggerEvent("imageFloatedNone"),
        a.find("img").click()
    },
    a.Editable.prototype.floatImageRight = function(a) {
        this.addImageClass(a, "fr-fir"),
        this.isImage && this.$element.css("float", "right"),
        this.saveUndoStep(),
    ...
    a.Editable.prototype.replaceImage = function(a) {
        ...
        this.imageMode = !0,
        this.$image_wrapper.find('input[type="text"]').val(a.find("img").attr("src"));
        var b = a.find("img");
    ...
    a.Editable.prototype.removeImage = function(b) {
        ...
        if (a.Editable.LANGS[this.options.language] && (d = a.Editable.LANGS[this.options.language].translation[d]), confirm(d)) {
            if (this.triggerEvent("beforeRemoveImage", [a(c)], !1)) {
                ...
                b.parents(".f-img-wrap").length ? b.parents(".f-img-wrap").remove() : b.remove(),
                this.refreshImageList(!0),
                this.hide(),
                e.length && e[0] != this.$element.get(0) && "" === a(e[0]).text() && a(e[0]).remove(),
                this.saveUndoStep(),
                this.wrapText(),
                this.triggerEvent("afterRemoveImage", [a(c)]),
                this.focus(),
                this.imageMode = !1
            }
    ...
    a.Editable.prototype.setImageAlt = function(a) {
        a.find("img").attr("alt", this.$image_editor.find('.f-image-alt input[type="text"]').val()),
        a.find("img").attr("title", this.$image_editor.find('.f-image-alt input[type="text"]').val()),
        this.saveUndoStep(),
        this.hide(),
        this.closeImageMode(),
    ...
    a.Editable.prototype.buildDragUpload = function() {
        var b = this;
        b.$image_wrapper.on("dragover", "#f-upload-div-" + this._id,
        function() {
            return a(this).addClass("f-hover"),
            !1
        }),
        b.$image_wrapper.on("dragend", "#f-upload-div-" + this._id,
        function() {
            return a(this).removeClass("f-hover"),
            !1
        }),
        b.$image_wrapper.on("drop", "#f-upload-div-" + this._id,
        function(c) {
            return c.preventDefault(),
            c.stopPropagation(),
            b.options.imageUpload ? (a(this).removeClass("f-hover"), void b.uploadImage(c.originalEvent.dataTransfer.files)) : !1
        }),
        b.$element.on("dragover dragenter dragend",
        function() {
            return ! 1
        }),
        b.$element.on("drop",
        function(c) {
            if (b.closeImageMode(), b.hide(), b.imageMode = !1, !b.options.imageUpload || 0 !== b.$element.find(".fr-image-move").length) {
                if (b.$element.find(".fr-image-move").length > 0 && b.options.imageMove) {
                    ...
                    b.insertHTML(d),
                    b.$element.find(".fr-image-move").remove(),
                    b.clearSelection(),
                    setTimeout(function() {
            ...
            if (c.originalEvent.dataTransfer && c.originalEvent.dataTransfer.files && c.originalEvent.dataTransfer.files.length) {
                ...
                b.uploadImage(c.originalEvent.dataTransfer.files),
                c.preventDefault(),
                c.stopPropagation()
            }
        })
    ...
    a.Editable.prototype.showImageLoader = function(a) {
        void 0 === a && (a = !1),
        a ? this.$progress_bar.find("span").css("width", "100%").text("Please wait!") : this.$image_wrapper.find("h4").addClass("uploading"),
    ...
    a.Editable.prototype.writeImage = function(b, c) {
        ...
        this),
        d.onload = this.imageMode ? a.proxy(function() {
            ...
            this.saveUndoStep(),
            this.enable(),
            this.triggerEvent("imageReplaced", [a]),
            setTimeout(function() {
                a.trigger("click")
            },
            0)
    ...
    a.Editable.prototype.insertLoadedImage = function(a) {
        ...
        this.focus(),
        this.wrapText(),
        this.triggerEvent("imageInserted", [a])
    },
    ...
    a.Editable.prototype.throwImageError = function(a) {
        ...
        1 == a ? b = "Bad link.": 2 == a ? b = "No link in upload response.": 3 == a ? b = "Error during file upload.": 4 == a ? b = "Parsing response failed.": 5 == a ? b = "Image too large.": 6 == a ? b = "Invalid image type.": 7 == a && (b = "Image can be uploaded only to same domain in IE 8 and IE 9."),
        this.triggerEvent("imageError", [{
            code: a,
            message: b
        }], !1),
        ...
        if (void 0 !== b && b.length > 0) {
            ...
            if (this.drag_support.formdata && (c = this.drag_support.formdata ? new FormData: null), c) {
                ...
                if (this.options.imageUploadToS3 !== !1) {
                    ...
                    c.append("Content-Type", b[0].type),
                    c.append("key", this.options.imageUploadToS3.keyStart + (new Date).getTime() + "-" + b[0].name)
                }
                if (c.append(this.options.imageUploadParam, b[0]), b[0].size > this.options.maxImageSize) return this.throwImageError(5),
                !1;
                if (this.options.allowedImageTypes.indexOf(b[0].type.replace(/image\//g, "")) < 0) return this.throwImageError(6),
                !1
            }
            if (c) {
                var e;
                this.options.crossDomain ? e = this.createCORSRequest("POST", this.options.imageUploadURL) : (e = new XMLHttpRequest, e.open("POST", this.options.imageUploadURL)),
    ...
    a.Editable.prototype.parseImageResponseXML = function(b) {
        try {
            ...
            d = a(b).find("Key").text();
            this.options.imageUploadToS3.callback.call(this, c, d),
    ...
    a.Editable.prototype.setImageUploadURL = function(a) {
        a && (this.options.imageUploadURL = a),
        this.options.imageUploadToS3 && (this.options.imageUploadURL = "https://" + this.options.imageUploadToS3.bucket + "." + this.options.imageUploadToS3.region + ".amazonaws.com/")
    },
    a.Editable.prototype.closeImageMode = function() {
        this.$element.find("span.f-img-editor > img").each(a.proxy(function(b, c) {
            this.addImageClass(a(c), this.getImageClass(a(c).parent().attr("class"))),
            a(c).parents(".f-img-wrap").length > 0 ? "A" == a(c).parent().parent().get(0).tagName ? a(c).siblings("span.f-img-handle").remove().end().unwrap().parent().unwrap() : a(c).siblings("span.f-img-handle").remove().end().unwrap().unwrap() : a(c).siblings("span.f-img-handle").remove().end().unwrap()
        },
        this)),
        this.$element.find("span.f-img-editor").length && (this.$element.find("span.f-img-editor").remove(), this.$element.parents("span.f-img-editor").remove()),
        this.$element.removeClass("f-non-selectable"),
        this.editableDisabled || this.isHTML || this.$element.attr("contenteditable", !0),
        this.$image_editor && this.$image_editor.hide(),
        this.$link_wrapper && this.options.linkText && this.$link_wrapper.find('input[type="text"].f-lt').parent().removeClass("fr-hidden")
    },
    a.Editable.prototype.refreshImageList = function(b) {
        if (!this.isLink && !this.options.editInPopup) {
            ...
            if (this.$element.find("img").each(function(b, f) {
                ...
                e.options.textNearImage ? g.removeClass("fr-tni") : g.addClass("fr-tni"),
                g.css("margin", ""),
                g.css("float", "")
    ...
    a.Editable.prototype.insertImage = function() {
        ...
        this.showInsertImage(),
        this.saveSelectionByMarkers(),
        this.options.inlineMode || this.positionPopup("insertImage"),
        this.imageMode = !1,
...
function(a) {
    ...
    a.Editable.prototype.initLinkEvents = function() {
        ...
        d = function(c) {
            ...
            if ("" !== b.text()) return b.hide(),
            !1;
            b.link = !0,
            b.clearSelection(),
            b.removeMarkers(),
            b.selectionDisabled || (a(this).before('<span class="f-marker" data-type="true" data-id="0" data-fr-verified="true"></span>'), a(this).after('<span class="f-marker" data-type="false" data-id="0" data-fr-verified="true"></span>')),
            b.restoreSelectionByMarkers(),
            b.exec("createLink");
            var d = a(this).attr("href") || "";
            b.$link_wrapper.find("input.f-lt").val(a(this).text()),
            b.isLink ? ("#" == d && (d = ""), b.$link_wrapper.find("input#f-lu-" + b._id).val(d.replace(/\&amp;/g, "&")), b.$link_wrapper.find(".f-external-link").attr("href", d || "#")) : (b.$link_wrapper.find("input.f-lu").val(d.replace(/\&amp;/g, "&")), b.$link_wrapper.find(".f-external-link").attr("href", d)),
            b.$link_wrapper.find('input[type="checkbox"]').prop("checked", "_blank" == a(this).attr("target")),
            b.$link_wrapper.find("li.f-choose-link-class").each(a.proxy(function(b, c) {
                a(this).hasClass(a(c).data("class")) && a(c).click()
            },
            this)),
            b.showByCoordinates(a(this).offset().left + a(this).outerWidth() / 2, a(this).offset().top + (parseInt(a(this).css("padding-top"), 10) || 0) + a(this).height()),
            b.$link_wrapper.find("input.f-lu").focus(),
            b.showInsertLink(),
            a(this).hasClass("fr-file") ? b.$link_wrapper.find("input.f-lu").attr("disabled", "disabled") : b.$link_wrapper.find("input.f-lu").removeAttr("disabled"),
            b.closeImageMode()
        };
    ...
    a.Editable.initializers.push(a.Editable.prototype.initLink),
    a.Editable.prototype.removeLink = function() {
    ...
    function C(a, b, c) {
        ...
        a.velocityX = .3 * a.velocityX + .7 * a.deltaX / d,
        a.velocityY = .3 * a.velocityY + .7 * a.deltaY / d,
        a.pageX = b.pageX,
        a.pageY = b.pageY
        }
    function D(a, b, c) {
...
window.WYSIWYGModernizr = function(a, b, c) {
    ...
    s = function(a, c, d, e) {
        ...
        h.id = e ? e[d] : l + (d + 1),
        j.appendChild(h);
        return f = ["&#173;", '<style id="s', l, '">', a, "</style>"].join(""),
        j.id = l,
        (m ? j: n).innerHTML += f,
        n.appendChild(j),
        m || (n.style.background = "", n.style.overflow = "hidden", i = k.style.overflow, k.style.overflow = "hidden", k.appendChild(n)),
        g = c(j, a),
    ...
    t = function(b) {
        ...
        var d;
        return s("@media " + b + " { #" + l + " { position: absolute; } }",
        function(b) {
    ...
    p.touch = function() {
        var c;
        return "ontouchstart" in a || a.DocumentTouch && b instanceof DocumentTouch ? c = !0 : s(["@media (", o.join("touch-enabled),("), l, ")", "{#modernizr{top:9px;position:absolute}}"].join(""),
        function(a) {
            c = 9 === a.offsetTop
        }),
        c
...
!
function(a) {
    a.Editable.TAG_ORDER = ["table", "thead", "tbody", "tfoot", "tr", "th", "td", "ul", "ol", "li", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote", "p", "div", "a", "strong", "em", "strike", "u", "span", "iframe", "object", "param", "video", "source"],
    a.Editable.SEPARATE = ["th", "td", "li", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote", "p", "div"],
    a.Editable.END_AT_SAME_INDEX = ["table", "thead", "tbody", "tfoot", "tr", "th", "td", "a", "span", "iframe", "div", "object", "param"],
    ...
    a.Editable.SELF_CLOSING_TAGS = ["br", "button", "input", "img", "hr", "param", "!--", "source"],
    a.Editable.SELF_CLOSING_AFTER = ["source"],
    a.Editable.prototype.isSelfClosingTag = function(b) {
    ...
    a.Editable.prototype.mergeStyle = function(b, c) {
        for (var d = {},
        e = a.Editable.uniq(a.merge(Object.keys(b.style), Object.keys(c.style))), f = 0; f < e.length; f++) {
            var g = e[f];
    ...
    a.Editable.prototype.mapDOM = function(b, c) {
        ...
        for (var o = 0; o < b.length; o++) if (d = b.charAt(o), "<" == d) {
        ...
        } else a.Editable.SEPARATE.indexOf(g) >= 0 && (r ? r.push('data-fr-idx="' + o + '"') : r = ['data-fr-idx="' + o + '"']),
                j.push({
            type: g,
            attrs: r,
            style: t,
            ...
            for (g in m) {
                ...
                for (var z = 0; z < f.length; z++) {
                    e = j[f[z]];
                    var A = this.tagKey(e);
                    l[h][A] ? l[h][A].style = this.mergeStyle(l[h][A], e) : l[h][A] = a.extend({},
                    e)
        }
        }
            h++
    ...
    a.Editable.prototype.froalaDOM = function(b) {
        ...
        f = 0; f < b.length; f++) {
            var g = b[f];
            for (c in e) g[c] || (e[c].end = f, d.push(a.extend({},
            e[c])), delete e[c]);
            for (var h in g) e[h] || (g[h].start = f, e[h] = g[h])
        }
        for (c in e) e[c].end = b.length,
        d.push(e[c]);
        return d
        },
    ...
    a.Editable.prototype.cleanOutput = function(b, c) {
        ...
        for (b = "", e = 0; e <= k.length; e++) {
            ...
            if (l[e]) for (l[e] = l[e].sort(this.sortNodes), f = 0; f < l[e].length; f++) d = l[e][f],
            m[d.end] || (m[d.end] = []),
            m[d.end].push(d),
            b += this.openTag(d);
            b += o,
    ...
    a.Editable.prototype.cleanify = function(b, c) {
        ...
        this.no_verify = !0,
        this.saveSelectionByMarkers(),
        d = b ? this.getSelectionElements() : this.$element.find(e);
        var f, g;
        if (d[0] != this.$element.get(0)) for (var h = 0; h < d.length; h++) {
            var i = a(d[h]);
            f = i.html(),
            g = this.cleanOutput(f, c),
            g !== f && i.html(g)
